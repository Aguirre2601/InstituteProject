...
$pageTitle = "Editar Perfil Profesor";
...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-primary border-bottom pb-2">Editar Mi Perfil</h1>
        
        <a href="/profesor/dashboard" class="btn btn-m">
            Volver al Dashboard
        </a>
    </div>
    ...
    <form action="/profesor/actualizarPerfil" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <fieldset class="border p-4 shadow-sm mb-4">
                    <legend class="float-none w-auto px-1 fs-5 text-warning">Cambiar Contraseña (Opcional)</legend>
            ...
            <div class="col-12">
                <fieldset class="border p-4 shadow-sm mb-4">
                    <legend class="float-none w-auto px-1 fs-5 text-info">Carreras Asignadas</legend>
                    
                    <label class="form-label d-block text-muted">Marque o desmarque las carreras que tiene asignadas:</label>
